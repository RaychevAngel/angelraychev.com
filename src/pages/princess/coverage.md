...
title: "Rectangle capture time: exact coverage"
description: "Accepted formulas, exact evaluators, direct strategies and the precise remaining parameter ranges."
updated: 2026-09-13
---
...
Sources: [sec:foundations](/princess/proofs/#sec:foundations), the introduction's cited feasibility result,
[thm:bounded-odd-frontier](/princess/proofs/#thm:bounded-odd-frontier), [thm:even-rectangle-high-budget](/princess/proofs/#thm:even-rectangle-high-budget), and
[thm:odd-short-even-high-budget](/princess/proofs/#thm:odd-short-even-high-budget). No new feasibility or endpoint theorem is
...
`PathClassification.lean`. Source: [eq:path-main](/princess/proofs/#eq:path-main), [sec:paths](/princess/proofs/#sec:paths).
...
ordinary proof and semantic review. Sources: [eq:ladder-main](/princess/proofs/#eq:ladder-main), [sec:two-rows](/princess/proofs/#sec:two-rows).
...
physical-game Lean classification. Sources: [eq:three-main](/princess/proofs/#eq:three-main), [sec:three-rows](/princess/proofs/#sec:three-rows).
...
Sources: [eq:four-main](/princess/proofs/#eq:four-main), [sec:four-rows](/princess/proofs/#sec:four-rows), [thm:even-rectangle-high-budget](/princess/proofs/#thm:even-rectangle-high-budget).
...
Sources: [thm:five-row-time](/princess/proofs/#thm:five-row-time), [thm:five-even-all-budgets](/princess/proofs/#thm:five-even-all-budgets),
[thm:five-odd-all-budgets](/princess/proofs/#thm:five-odd-all-budgets).
...
Source: [thm:even-rectangle-high-budget](/princess/proofs/#thm:even-rectangle-high-budget).
...
Sources: [thm:odd-rectangle-high-budget](/princess/proofs/#thm:odd-rectangle-high-budget), [cor:odd-rectangle-root-free-time](/princess/proofs/#cor:odd-rectangle-root-free-time).
...
not a complete physical Lean theorem. Source: [thm:odd-short-even-high-budget](/princess/proofs/#thm:odd-short-even-high-budget).
...
classification. Source: the constant list in [thm:odd-minimum-budget](/princess/proofs/#thm:odd-minimum-budget) and
